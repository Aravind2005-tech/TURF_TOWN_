    ...
    return Scaffold(
      ...
      Consumer<ScoreManager>(
        builder: (context, manager, _) {
          ...
          //           const Text('Cricket', style: TextStyle(fontSize: 35, color: Colors.white)),
          //           const SizedBox(width: 5),
          //           const Padding(
          //             padding: EdgeInsets.only(top: 10),
          //             child: Text('Scorer', style: TextStyle(fontSize: 18, color: Colors.white)),
          //           ),
          //         ],
          //       ),
          //
          ...
          //           gradient: LinearGradient(
          //             colors: [Color(0xFF6E6679),Color(0xFF181719)], // blue gradient
          //             begin: Alignment.topCenter,
          //             end: Alignment.bottomCenter,
          //           ),
